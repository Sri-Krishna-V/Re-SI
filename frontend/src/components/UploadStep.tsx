        ...
        <>
          ...
          >
            ...
            <h3 className="text-2xl font-semibold mb-2">
              {isUploading ? "Uploading..." : "Drop your RSI skill pack here"}
            </h3>
          ...
          <div>
            <p className="text-center text-zinc-500 mb-4">
              {isAnalyzing ? "Analyzing with RSI agents..." : "Or try an RSI example skill:"}
            </p>
          ...
          <div className="glass rounded-2xl p-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold mb-1">{metadata?.name || "RSI Skill Uploaded"}</h3>
